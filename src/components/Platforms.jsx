// Trading platform line-up (XT, cTrader, mobile, web).
      ...
      <div className="platforms-inner">
        ...
        <div className="platform-grid">
          <article className="platform-card">
            ...
            <a href="/login">Learn about XT <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right" aria-hidden="true"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></a>
          </article>
        ...
        <div className="glass-ticket platform-glass-ticket" aria-label="Platform access details">
          ...
          <span>
            ...
            <strong>XT, cTrader and mobile in one account</strong>
          </span>
