...
export const PLATFORMS = [
  {
    ...
    name: 'MetaTrader 5',
    tag: 'Recommended',
    title: 'MetaTrader 5, connected to raw liquidity',
    lead: 'The industry standard, running on our execution stack. Twenty-one timeframes, native hedging, Depth of Market and unrestricted Expert Advisors on desktop, web and mobile.',
    highlights: ['No requotes', 'Hedging & netting', 'EAs & custom indicators', 'Depth of Market'],
    downloads: [
    ...
    features: [
      ...
      ['Automated trading', 'Expert Advisors & MQL5'],
      ['Position accounting', 'Hedging & netting'],
      ['Markets', 'FX, indices, metals, energy, shares, crypto'],
    ],
    faq: [
      { q: 'Is MetaTrader 5 free?', a: 'Yes. Download it for any device from your client portal and log in with your Movement Markets account. Demo accounts are free too.' },
      { q: 'Can I use my existing EAs and indicators?', a: 'Anything written for MT5 runs as-is. MT4 code needs porting to MQL5; most popular tools already have MT5 versions.' },
  ...
  },
  {
    ...
    lead: 'A full trading terminal that opens in a tab. The same account, the same prices and the same execution as MetaTrader 5, on whatever machine is in front of you.',
    highlights: ['Zero install', 'Syncs with MT5', 'One-click trading', 'Works on any OS'],
    downloads: [
    ...
    features: [
      ...
      ['Account sync', 'Shared with MT5 in real time'],
      ['Two-factor login', 'Yes'],
      ['Browsers', 'Chrome, Safari, Firefox, Edge'],
    ],
    faq: [
      { q: 'Do I need a separate account for WebTrader?', a: 'No. WebTrader and MetaTrader 5 share the same account and positions. Open a trade in one and manage it in the other.' },
      ...
      { q: 'Can I run automated strategies?', a: 'Not in WebTrader. Expert Advisors need the MetaTrader 5 desktop terminal or a VPS.' },
    ],
  },
];
...
export const ACCOUNT_FAQ = [
  { q: 'Which account should I start with?', a: 'If you trade a few times a week and want one simple number, Standard. If you scalp, trade news or run high volume, Raw usually works out cheaper because the commission is fixed and the spread is the market’s own.' },
  ...
  { q: 'Is there a demo account?', a: 'Every client gets a free demo that mirrors live pricing on both account types. It never expires while you keep using it.' },
...
export const HELP = [
  ...
  },
  {
    title: 'Platforms',
    items: [
      { q: 'Which platforms do you offer?', a: 'MetaTrader 5 on Windows, macOS, iOS and Android, and Movement WebTrader in any modern browser.' },
      { q: 'Can I use TradingView charts?', a: 'WebTrader includes TradingView-powered charting. MetaTrader 5 uses its own charting engine.' },
